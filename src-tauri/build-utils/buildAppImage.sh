...
mkdir -p $APP_DIR/usr/lib/Jan-${RELEASE_CHANNEL}/binaries/engines
cp -f ./src-tauri/binaries/deps/*.so* $APP_DIR/usr/lib/Jan-${RELEASE_CHANNEL}/binaries/
cp -f ./src-tauri/binaries/*.so* $APP_DIR/usr/lib/Jan-${RELEASE_CHANNEL}/binaries/
cp -rf ./src-tauri/binaries/engines $APP_DIR/usr/lib/Jan-${RELEASE_CHANNEL}/binaries/
